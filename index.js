...
client.on('guildMemberAdd', member => {
    member.guild.channels.cache.get(config.greeting.channel)( new Discord.MessageEmbed()
        .setDescription(`🎉 **${member} a rejoint le serveur !** **Pense à prendre t'es rôles** #🎭・rôles `Nous sommes ${member.guild.memberCount} ! 🎉` `)
        .setColor('#6C00FF'))
